...
public class MyString {
    public static void main(String args[]) {
        ...
        System.out.println(subsetOf("cost","ocostraz"));// returns true
        ...
        System.out.println(spacedString("word"));
        System.out.println(spacedString("apples"));
        System.out.println(spacedString("testing"));
    ...
    public static String randomStringOfLetters(int n) {
        ...
        String newstring = ""; 
        for (int i = 0; i < n; i++) {
         int spot = (int) (Math.random() * 26);
        newstring += alpha.charAt(spot);
        }
        return newstring;
    }
